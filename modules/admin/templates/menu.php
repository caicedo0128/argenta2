  ...
  <div class="container-fluid">
    ...
    <div id="navbar-main" class="navbar-collapse collapse titulo-menu">
      <ul class="nav navbar-nav">
        ...
        <li class='administrador consulta'><a href="admindex.php?mod=clientes&action=vinculacion">Vinculación</a></li>
        ...
        <li class="dropdown">
          ...
          <ul aria-labelledby="themes" class="dropdown-menu">
            ...
            <li class='administrador consulta'><a href="admindex.php?mod=reportes&action=reporteFacturacion">Facturación</a></li>
          </ul>
        </li>
		...
		?>
			...
			<li class='administrador cliente'>
			  <a href="admindex.php?mod=clientes&action=listDocumentosClienteVinculacion">Documentación vinculación</a>
			</li>
			<li class='administrador cliente'>
