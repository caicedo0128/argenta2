...
<div class="panel panel-primary col-md-offset-2 col-md-8">
    <div class="panel-body">
        ...
        <form id="datosEstudio" method="post" name="datosEstudio" action="admindex.php" enctype="multipart/form-data">        
            ...
            <div class="row">
                <div class="col-md-2 labelCustom">A�o:</div>
                <div class="col-md-3"> 
                <?php
			...
			<div class="alert alert-success">Condiciones de aprobaci�n.</div> 
            <div class="row">
				<div class="col-md-3 labelCustom">
					...
					<?php 
						...
						echo "<small>�ltimo cupo aprobado:<br/>".formato_moneda($estudio->cupo)."</small>";
					?>           
					</div>            
				</div>
