...
function calcularReliquidacionPTP(){
    ...
    if (fechaRealPago != "" && factorTotal != ""){
        ...
        //TASA CALCULO
        var tasa = factorTotal / 100;

        //VALOR OBLIGACION A FECHA PAGO REAL
        var potenciaMargen = Math.pow(1 + tasa,((diasReliquidar * -1) / 365));
        var valorObligacion =  Math.round((deudaFechaPagoPactada / potenciaMargen)) + valorTotalIva;
        $(".text_valor_obligacion").text(valorObligacion);
        $('.text_valor_obligacion').priceFormat({
            allowNegative: true,
            prefix: '$ ',
            centsSeparator: ',',
            thousandsSeparator: '.',
        ...
        var remanentes = valorPago - valorObligacion;
        ...
        //INTERESES MORA
        var interesesMora = (valorObligacion - deudaFechaPagoPactada) - valorTotalIva;
    ...
    if (valorPago < valorObligacion && valorPago != ""){
...
function calcularReliquidacionPTPAnterior(){
    ...
    if (fechaRealPago != "" && factorTotal != ""){
        ...
        //VALOR OBLIGACION A FECHA PAGO REAL
        var potenciaMargen = Math.pow(1 + tasa,((diasReliquidar * -1) / 365));
        var valorObligacion =  Math.round((deudaFechaPagoPactada / potenciaMargen));
        $(".text_valor_obligacion").text(valorObligacion);
        $('.text_valor_obligacion').priceFormat({
            allowNegative: true,
            prefix: '$ ',
        ...
        //INTERESES MORA
        var interesesMora = valorObligacion - deudaFechaPagoPactada;
        $("#intereses_mora").val(interesesMora);
        $(".text_intereses_mora").text(interesesMora);
        $(".text_intereses_mora").priceFormat({
            allowNegative: true,
...
<div class="col-md-6">
	<?php
		...
		$functionCalculos = "calcularReliquidacionPTP";
		if ($operacion->fecha_operacion < "2019-01-01"){
			$functionCalculos = "calcularReliquidacionPTPAnterior";
		}		
	?>
    <div class="row">
    	<input type="hidden" name="intereses_mora" id="intereses_mora" value="<?=$reliquidacionPT->intereses_mora?>">
    ...
    <div class="row">
        <div class="col-md-3 labelCustom">
        	Nuevo valor de la obligación:
        	<div class="form-control text-right" disabled="disabled">
        		<span class="text_valor_obligacion"></span>
        	</div>
        </div>
        <div class="col-md-3 labelCustom">
...
<div class="col-md-3">
    ...
    <table id="reliquidacion_cliente" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" style="width:100%;">
        ...
        <tr style="background-color:#F9F9F9;">
            ...
            <td class="td_border right">
                ...
                <input type="hidden" name="gmf" id="gmf_ptp" value="<?=$reliquidacionPT->gmf?>">
            </td>
        </tr>
        <tr>
