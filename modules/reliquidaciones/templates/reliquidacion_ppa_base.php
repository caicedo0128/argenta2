<div class="container-fluid"> 
	<div class="col-md-6">
		<?php
			...
			$functionCalculos = "calcularReliquidacionPPA";
			if ($operacion->fecha_operacion < "2019-01-01"){
				$functionCalculos = "calcularReliquidacionPPAAnterior";
			}		
		?>
		<div class="row" style="height:10px;">&nbsp;</div>    
		<div class="row">            
			<input type="hidden" name="fecha_desembolso" id="fecha_desembolso" value="<?=$operacion->fecha_operacion?>">
			<input type="hidden" name="intereses_mora" id="intereses_mora" value="0">
		...
		<div class="row">    
			...
			<div class="col-md-3 labelCustom">
				...
				<div class="">   
					<?php 
						$tasa = $operacion->tasa_inversionista;
						if ($reliquidacionPP->tasa != "")
							$tasa = $reliquidacionPP->tasa;

						$c_textbox = new Textbox;
						echo $c_textbox->Textbox ("tasa", "tasa", 0, $tasa, "form-control required", 50, "7", $functionCalculos."();", "1","","");             
				   ?>  
				</div>           	
			</div>              
		</div>           
		...
		<div class="row">            
			...
			<div class="col-md-3 labelCustom">
				...
				<div class="form-control" disabled="disabled">   
					<span id="text_intereses_devolver"></span>
					<input type="hidden" name="intereses_devolver" id="intereses_devolver" value="<?=$reliquidacionPP->intereses_devolver?>">    
				</div>           	
			</div>		
			<div class="col-md-3 labelCustom">
