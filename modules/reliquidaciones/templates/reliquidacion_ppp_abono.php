...
$(document).ready(function(){
    ...
    $('#fecha_real_pago_abono').datetimepicker({ format: 'YYYY-MM-DD', showClear: true });
...
<form id="datosRegistroReliquidacionAbono" method="post" name="datosRegistroReliquidacionAbono" action="admindex.php" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <span id="text_valor_obligacion_pp_abono"></span>
            <input type="hidden" name="valor_obligacion_pp_abono" id="valor_obligacion_pp_abono" value="">
       </div>
    </div>
    <div class="row" style="height:10px;">&nbsp;</div>
    <div class="row">
    ...
    <div class="row devoluciones_abono">
        ...
        <div class="col-md-4">
        <span id="text_gmf_ppp"></span>
        <input type="hidden" name="gmf" id="gmf_ppp" value="<?=$reliquidacionPP->gmf?>">
       </div>
    </div>
    <div class="row devoluciones_abono" style="height:10px;">&nbsp;</div>
    <div class="row devoluciones_abono">
