...
<div class="row-fluid">
    ...
    <div id="content_reliquidaciones" class="" style="clear:both;padding-top:10px;">
            ...
            <thead>
                <tr>
                    <th>Opciones</th>
                    <th>Cod. reliquidaci�n</th>
                    <th>Fecha</th>
                    <th>Nro Factura</th>
                    <th>Tipo reliquidaci�n</th>
                            ...
                            <td align="center">
                                ...
                                <?php
                                    if ($operacion->estado == 1 && $_SESSION["profile_text"]!="Cliente" || $_SESSION["profile_text"]=="Administrador")
                                        ...
                                        {
                                        //Opcion a ejecutar si tiene el permiso
                                        echo "<a href=\"javascript:editReliquidacion(".$idReliquidacion.");\"><img border=\"0\" alt=\"Editar re-liquidaci�n\" title=\"Editar re-liquidaci�n\" src=\"./images/editar.png\"></a>";
                                        }
                                ?>
                                ...
                                <?php
                                    if ($operacion->estado == 1 && $_SESSION["profile_text"]!="Cliente")
                                        ...
                                        {
                                        //Opcion a ejecutar si tiene el permiso
                                        echo "<a href=\"javascript:deleteReliquidacion(".$idReliquidacion.");\"><img border=\"0\" alt=\"Eliminar re-liquidaci�n\" title=\"Eliminar re-liquidaci�n\" src=\"./images/eliminar.png\"></a>";
                                        }
                                    else
                                        echo "N/D";
                                ?>
