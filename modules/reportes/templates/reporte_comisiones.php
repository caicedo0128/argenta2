    ...
    <div class="panel panel-primary col-md-12">
        <div class="panel-body">
            <form id="datosRegistro" method="post" name="datosRegistro" action="admindex.php" enctype="multipart/form-data">        
                ...
                <input type="hidden" name="action" value="generarReporteComisiones" />
                ...
                <div class="row" style="height:10px;">&nbsp;</div>    
                <div class="row">            
                    <div class="col-md-3 labelCustom">Ejecutivo:</div>
                    <div class="col-md-3">
                    <?php

                        $sede_select = new Select("id_ejecutivo","Tercero",$arrEjecutivos,"",0,"", "form-control", 0, "", "", 0);
                    ...
                    <div class="col-md-4">
                        ...
                        <?php
                            $c_radio = new Radio;
                            $arrSiNo = array("1"=>"Comisión pagada","2"=>"Sin pagar");
            ...
            <center>
                <input type="button" value="Consultar" class="btn btn-primary datos_reporte_btnSave" onclick="generarReporteComision();">
            </center>   
