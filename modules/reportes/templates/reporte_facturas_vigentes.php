...
<div class="row-fluid">
    <div class="col-md-12 bg-primary-custom">
        <h4>Reporte facturas vigentes</h4>
    </div>
</div>
    ...
    <div class="panel panel-primary">
        <div class="panel-body">
            <form id="datosRegistro" method="post" name="datosRegistro" action="admindex.php" enctype="multipart/form-data">
                ...
                <input type="hidden" name="action" value="<?=($_SESSION["profile_text"]=="Cliente"?"generarReporteFacturasVigentesCliente":"generarReporteFacturasVigentes")?>" />
