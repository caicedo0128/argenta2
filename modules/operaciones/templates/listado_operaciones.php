...
function deleteOperacion(idOperacion) {
	...
	bootbox.confirm({
		title: "Confirmaci�n",
		message: "Usted va a eliminar la operaci�n. El proceso no se podra deshacer.<br/><br/>Realmente desea continuar?",
		closeButton: true,
		buttons: {
			confirm: {
				label: 'Si',
...
<div class="row-fluid">
    ...
    <div id="content_operaciones" class="" style="clear:both;padding-top:15px;">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td align="center"><a href="javascript:editOperacion(<?=$idOperacion?>);"><img border="0" alt="Editar operaci�n" title="Editar operaci�n" src="./images/editar.png"></a></td>
                            <td align="center">
                                <?php
                                    //SI ESTA CREADA
                                    if ($idEstado == 3 || $idEstado == 4){
                                ?>
                                    <a href="javascript:deleteOperacion(<?=$idOperacion?>);"><img border="0" alt="Eliminar operaci�n" title="Eliminar operaci�n" src="./images/eliminar.png"></a>
                                <?php
                                    }
                                    else{
                                        echo "N/D";
