    ...
    <div class="panel panel-primary col-md-offset-2 col-md-8  ">
        <div class="panel-body reporte-cliente" style="font-size:10px;">
            ...
            <table width="100%" border="1" cellpadding="2">
                ...
                <tr>
                    <td><b>GMF:</b></td>
                    <td><?=formato_moneda(($operacion->gmf_manual!=0?$operacion->gmf_manual:$operacion->gmf))?></td>
                    <td><b>Otros:</b></td>                   
			...
			<?php
				//DATOS PARA IMPRIMIR
				$gmfCalculos = ($operacion->gmf_manual!=0?$operacion->gmf_manual:$operacion->gmf);
				$iva = ($gmfCalculos * 19)/100;
			?>
			<br/>
			<table width="50%" border="1" cellpadding="2" style="font-size:7x;">
				<tr>
					<td>Giro antes GMF:</td>
					<td align="right"><?=formato_moneda($totalGiroGMF)?></td>
				</tr>
				<tr>
					<td>Costo giro a tercero:</td>
					<td align="right"><?=formato_moneda($gmfCalculos)?></td>
				</tr>
				<tr>
					<td>IVA 19%:</td>
					<td align="right"><?=formato_moneda($iva)?></td>
				</tr>
				<tr>
					<td>Factura giro a tercero:</td>
					<td align="right"><?=formato_moneda($gmfCalculos + $iva)?></td>
				</tr>	
				<tr>
					<td>Valor giro final:</td>
					<td align="right"><?=formato_moneda($totalGiroGMF - ($gmfCalculos + $iva))?></td>
				</tr>	
			</table>
            <br/><br/><br/><br/>  
            Cordialmente,
