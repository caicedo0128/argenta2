		   ...
		   documentReference.forEach(element =>{
		   		...
		   		if (nroFactura == "" && cufe == ""){
					...
					data.forEach(elementData =>{
						...
						nroFactura = elementData.children[5].innerHTML;
						cufe = elementData.children[6].innerHTML;
						fechaEmision = elementData.children[7].innerHTML;
						fechaVencimiento = elementData.children[9].innerHTML;
						totalNeto = elementData.children[21].children[1].innerHTML;
						totalBruto = elementData.children[21].children[2].innerHTML;
						...
						$("#valor_bruto").val(totalBruto.replace('.00',''));
						$("#cufe").val(cufe);
						liquidarFactura(true);
					});
				}
        ...
        <form id="datosFactura" method="post" name="datosFactura" action="admindex.php" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 labelCustom">
					...
					<?php
						...
						echo $c_textbox->Textbox ("cufe", "cufe", 1, $factura->cufe, "form-control", 50, "", "", "");
					?>
					</div>
                </div>                
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2 labelCustom">
					...
					<?php
						$c_textbox = new Textbox;
						echo $c_textbox->Textbox ("prefijo", "prefijo", 1, $factura->prefijo, "form-control", 50, "", "", "");
					?>
					</div>
                </div>
                <div class="col-md-2 labelCustom">
