...
<div class="row-fluid">
    <div class="col-md-12 bg-primary-custom">
        <h4>Informaci�n de par�metros del tercero</h4>
    </div>
</div>
...
<div class="panel panel-primary col-md-offset-2 col-md-9" style="padding-right:0px !important;padding-left:0px !important;">
    <div class="panel-body">
        Registro de informaci�n de aceptaci�n
        <hr/>
        ...
        <input type="hidden" name="id_cliente" id="id_cliente" value="<?=$idCliente?>" />
			<div class="row">     				
				<div class="col-md-4">
            		<div class="">Emite carta/correo de aceptaci�n general:</div>
				...
				<div class="col-md-4">
            		<div class="">Emite carta/correo de aceptaci�n espec�fica:</div>
			...
			<div class="row">              				
				<div class="col-md-8">
					<div class="">Correo electr�nico validaci�n:</div>
					<?php
