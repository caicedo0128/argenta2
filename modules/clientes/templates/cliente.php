...
function cambiarEstado(nuevoEstado,proceso){
	...
	bootbox.prompt({
		title: "Confirmaci�n",
		message: "Usted va a " + proceso + " el tercero. El proceso no se podr� deshacer. Desea continuar?<br/><br/>Ingrese comentarios:",
		closeButton: true,
		inputType: 'textarea',
		buttons: {
			confirm: {
...
function validarTipoTercero(){
    ...
    $(".titulo_razon_social").text("Raz�n social:");
...
function enviarReporte(){
	...
	if ($("#custom_data_to_email").valid()) {
		...
		showLoading("Enviando informaci�n por correo electr�nico...");
...
function savePagare(idCliente){
    ...
    if (pagare != ""){
        ...
        showError("El n�mero de pagar� es obligatorio.");
    }
}
	...
	$.ajax({
		...
		success: function (response) {
			...
			var dialog = bootbox.dialog({
				title: "Confirmaci�n motivo rechazo",
				message: response
			});
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModal">Enviar correo electr�nico a:</h4>
            </div>
